...
//User data
int servoPin = 4;
int pulseStartPoint = 7; //MIN start position is 5
int pulseEndPoint = 22;  //MAX end position is 25
int overflowValueCTC = 120;
...
void loop() {
  for(int i = pulseStartPoint; i<=pulseEndPoint;i++){
    pulseWidthScaled = i;
    delay(15);
  }
  delay(2000);
  for(int i = pulseEndPoint; i>=pulseStartPoint;i--){
    pulseWidthScaled = i;
    delay(15);
  }
  delay(2000);
